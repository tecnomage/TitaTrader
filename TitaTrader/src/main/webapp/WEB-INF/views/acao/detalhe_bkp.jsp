...
<link rel="shortcut icon"
	href="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/favicon.ico?1057931688501172147"
	type="image/ico" />
<link href="https://plus.google.com/108540024862647200608"
	rel="publisher">

<link rel="alternate" type="application/json+oembed"
	href="http://www.casadocodigo.com.br/products/livro-javaee.oembed" />

<!-- inject:css -->
<link rel="stylesheet"
	href="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/style.css?1057931688501172147">
...
#menu a {
	...
	<div id="menu">
		<ul>
			...
			<li><a href='<c:url value="produtos/lista/"/>'>Listagem de
					Livros</a></li>
		</ul>
	</div>
			...
			<div class="imagemLivroNinja " role="img">
				...
				<div class="imagemLivroNinja-tablet" style="" role="presentation">
					<svg width="181px" viewBox="0 0 181 242"
                        ...
                        <rect fill="#FFFFFE" x="17" y="27" width="146"
							height="185"></rect>
                        <image
							xlink:href="//cdn.shopify.com/s/files/1/0155/7645/products/G8Odq4Q1TChRM5NMkpWOfJLrIdpMhXpIMt0Qs0vOAJQ_size_mode_2_size_1024x768_large.jpeg?v=1447444684"
				...
				<ul class="adicionarAoCarrinho-listaOfertas">
					...
					<c:forEach items="${produto.precos}" var="preco">
						<li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope>
							...
							for="product-variant-10263481793"> <input type="radio"
								name="tipo" class="variant-radio" id="tipo"
								value="${preco.tipoPreco}" checked /> <span
								class="adicionarAoCarrinho-tipoDaOferta-nome">
									${preco.tipoPreco} </span>
